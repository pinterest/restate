...
pub mod proto {
    ...
    mod pb_conversion {
        ...
        impl super::Future {
            ...
            // `max_depth`.
            pub fn valid_max_depth(&self, max_depth: usize) -> bool {
    ...
    mod test {
        ...
        fn future_depth() {
            ...
            assert!(fut.valid_max_depth(2));
            assert!(fut.valid_max_depth(3));
            assert!(!fut.valid_max_depth(1));
            ...
            assert!(fut.valid_max_depth(10));
            assert!(!fut.valid_max_depth(9));
        }
    }
}
